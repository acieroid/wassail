(module
  ...
  (func (;17;) (type 1) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func (;18;) (type 16) (param i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;29;) (type 2) (param i32 i32 i32)
    ...
    i32.const 4
    call 33)
  (func (;30;) (type 2) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
    i32.const 0
  ...
  (func (;41;) (type 0) (param i32) (result i32)
    i32.const 0)
  (func (;42;) (type 2) (param i32 i32 i32)
    (local i32 i32)
    local.get 2
    i32.const 512
    i32.ge_u
  ...
  (data (;0;) (i32.const 1024) "tmp <= 10.0\00utilities/polybench.c\00polybench_flush_cache\00%0.6f\0a\00Error return from gettimeofday: %d\00[PolyBench] posix_memalign: cannot allocate memory\00==BEGIN DUMP_ARRAYS==\0a\00begin dump: %s\00R\00%0.2lf \00\0aend   dump: %s\0a\00Q\00==END   DUMP_ARRAYS==\0a\00\00 \07\00\00-+   0X0x\00(null)")
