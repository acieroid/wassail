(module
  ...
  (func (;18;) (type 15) (param i32 i32 i32 i32 i32 i32) (result i32)
  ...
  (func (;26;) (type 4) (param i32 i32) (result i32)
    ...
    local.get 1
    call 46)
  (func (;27;) (type 17) (param f64 i32) (result f64)
    (local i32 i64)
    local.get 0
    i64.reinterpret_f64
    local.tee 3
  ...
  (func (;31;) (type 0) (param i32) (result i32)
    ...
    local.get 2)
  (func (;32;) (type 9) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 208
    i32.sub
  ...
  (func (;38;) (type 3) (param i32)
    ...
    i32.add
    global.set 0)
  (func (;39;) (type 8) (param i32 i64 i32) (result i64)
    i64.const 0)
  ...
  (export "k" (func 20))
  (export "l" (func 37))
  (elem (;0;) (i32.const 1) 34 47 35 48 40 39)
  (data (;0;) (i32.const 1024) "tmp <= 10.0\00utilities/polybench.c\00polybench_flush_cache\00%0.6f\0a\00Error return from gettimeofday: %d\00[PolyBench] posix_memalign: cannot allocate memory\00==BEGIN DUMP_ARRAYS==\0a\00begin dump: %s\00imgOut\00%0.2f \00\0aend   dump: %s\0a\00==END   DUMP_ARRAYS==\0a\00\00\00\00 \07\00\00-+   0X0x\00(null)\00\00\00\00\00\00\00\00\11\00\0a\00\11\11\11\00\00\00\00\05\00\00\00\00\00\00\09\00\00\00\00\0b\00\00\00\00\00\00\00\00\11\00\0f\0a\11\11\11\03\0a\07\00\01\00\09\0b\0b\00\00\09\06\0b\00\00\0b\00\06\11\00\00\00\11\11\11")
