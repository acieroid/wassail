(module
  ...
  (func (;15;) (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func (;16;) (type 16) (param i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1024) "tmp <= 10.0\00utilities/polybench.c\00polybench_flush_cache\00%0.6f\0a\00Error return from gettimeofday: %d\00[PolyBench] posix_memalign: cannot allocate memory\00==BEGIN DUMP_ARRAYS==\0a\00begin dump: %s\00cov\00%0.2lf \00\0aend   dump: %s\0a\00==END   DUMP_ARRAYS==\0a\00\00 \07\00\00-+   0X0x\00(null)")
