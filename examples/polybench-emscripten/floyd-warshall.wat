(module
  ...
  (func (;29;) (type 0) (param i32) (result i32)
    ...
    local.get 2)
  (func (;30;) (type 9) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 208
    i32.sub
  ...
  (func (;49;) (type 11) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func (;50;) (type 16) (param i64 i32 i32) (result i32)
    local.get 0
    i64.eqz
    i32.eqz
    if  ;; label = @1
  ...
  (export "k" (func 18))
  (export "l" (func 35))
  (elem (;0;) (i32.const 1) 32 46 33 48 39 37)
  (data (;0;) (i32.const 1024) "tmp <= 10.0\00utilities/polybench.c\00polybench_flush_cache\00%0.6f\0a\00Error return from gettimeofday: %d\00[PolyBench] posix_memalign: cannot allocate memory\00==BEGIN DUMP_ARRAYS==\0a\00begin dump: %s\00path\00%d \00\0aend   dump: %s\0a\00==END   DUMP_ARRAYS==\0a\00 \07\00\00-+   0X0x\00(null)")
