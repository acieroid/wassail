(module
  ...
  (func (;10;) (type 0) (param i32) (result i32)
    ...
    i32.store
    i32.const -1)
  (func (;11;) (type 10) (param i64 i32) (result i32)
  ...
  (func (;26;) (type 4) (param i32 i32) (result i32)
    ...
    local.get 1
    call 47)
  (func (;27;) (type 18) (param f64 i32) (result f64)
    (local i32 i64)
    local.get 0
    i64.reinterpret_f64
    local.tee 3
  ...
  (func (;36;) (type 4) (param i32 i32) (result i32)
    ...
    loop  ;; label = @1
      ...
      loop  ;; label = @2
        ...
        i32.add
        f64.load
        f64.const 0x1.01fe03f61badp+4 (;=16.1245;)
        f64.mul
        f64.div
        f64.store
        local.get 3
  ...
  (func (;51;) (type 10) (param i64 i32) (result i32)
    ...
    local.get 1)
  (func (;52;) (type 17) (param i64 i32 i32) (result i32)
    local.get 0
    i64.eqz
    i32.eqz
    if  ;; label = @1
  ...
  (export "k" (func 20))
  (export "l" (func 37))
  (elem (;0;) (i32.const 1) 34 48 35 49 40 39)
  (data (;0;) (i32.const 1024) "tmp <= 10.0\00utilities/polybench.c\00polybench_flush_cache\00%0.6f\0a\00Error return from gettimeofday: %d\00[PolyBench] posix_memalign: cannot allocate memory\00==BEGIN DUMP_ARRAYS==\0a\00begin dump: %s\00corr\00%0.2lf \00\0aend   dump: %s\0a\00==END   DUMP_ARRAYS==\0a\00 \07\00\00-+   0X0x\00(null)")
