...
let of_wasm (m : Ast.module_) (fid : int) (f : Ast.func) (nargs : int) (nglobals : int): t = {
  body = fst (Instr.seq_of_wasm m fid f.it.body [] nargs (List.length f.it.locals) nglobals);
